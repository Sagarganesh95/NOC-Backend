...
module.exports = function(app) {
    ...
    app.route('/api/dashboard/getHostCount').post(dashBoardData.getHostCountCache, dashBoardData.getHostCount);
    ...
    app.route('/api/dashboard/getlocalDbCount').post(dashBoardData.getlocalDbCountCache, dashBoardData.getlocalDbCount);
    app.route('/api/dashboard/getDomainList').post(dashBoardData.getDomainListCache, dashBoardData.getDomainList);
}