            ...
            db[req.body.subdomain].sensorToBles.aggregate([
                ...
                if (deskUnCount.length > 0) {
                    deskUnCount.forEach(async desk => {
                        ...
                        var momentstart = moment.tz(dates.FromDate, desk.timezone).valueOf();
                        var momentend = moment.tz(dates.ToDate, desk.timezone).valueOf();
                        var sendStruc = {};
                        ...
                        sendStruc.id = ++count,
                            ...
                            sendStruc.lastresponsetime = moment.tz(desk.lastStatusUpdate, desk.timezone).format("DD-M-YYYY hh:mm A"),
                        ...
                        sendStruc.noofresponses = await gethealthLog(req.body.subdomain, startm, endm, desk.bleId)
